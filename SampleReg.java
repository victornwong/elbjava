...
public final String extractFolderNo(String iwhich)
{
	...
	if(iwhich.length() > 9) retval = iwhich.substring(4,10);
	return retval;
}
...
public final String extractFolderNo_FromSampleID(String iwhich)
{
	...
	if(!iwhich.equals("") && iwhich.length()  > 15) retval = iwhich.substring(4,10);
	return retval;
}
...
public final String extractFolderString_FromSampleID(String iwhich)
{
	...
	if(!iwhich.equals("") && iwhich.length() > 15) retval = iwhich.substring(0,10);
